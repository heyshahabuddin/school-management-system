...
// for global theme's settings, define settings in MaterialApp using 'theme:' property
        ...
        child: Center(
          child: Column(
            ...
            children: [
              Text(
                'Body Text',
                style: Theme.of(context).textTheme.bodyLarge,  //global theme settings
              ),
              Card(
                  child: ListTile(
              ...
              Text(
                'Font size according to device screen.',
                style: TextStyle(
                  fontSize: screenSize.width > 600 ? 32: 25,
                  fontWeight: screenSize.width > 600 ? FontWeight.bold : FontWeight.w500,
                ),
              ),
              SizedBox(height: 30,),
              ElevatedButton(
